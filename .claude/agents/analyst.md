...
NICE 시스템의 XLS 내보내기 형식, DB 스키마, AI 점검 규칙을 명세한다.

## 작업 원칙
- 사용법 PPTX와 첨부 자료를 철저히 읽고 기능 목록을 도출한다
- 데스크톱 기능을 웹으로 옮길 때 UX 단순화 기회를 식별한다
- NICE XLS 파일 5종(교과성적, 세특, 창체, 봉사, 행동특성)의 컬럼 구조를 추정하고 명세한다
...
- `_workspace/01_analyst_xls_schema.md`: NICE XLS 5종의 예상 컬럼 구조
